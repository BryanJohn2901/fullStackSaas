...
const Hero = () => {
    return (
        <section className='bg-white'>
            <div className='container mx-auto px-4 pr-20 sm:px-6 lg:px-8'>
                <main className='flex items-center justify-center'>
                    <article className='space-y-8 max-w-3xl flex flex-col justify-center'>
                        ...
                        <Button className='bg-emerald-500 hover:bg-emerald-600 w-fit text-lg px-8 py-6'>
                            Encontre uma clinica
                        </Button>
                    </article>

                    <div className='hidden lg:block'>
                        <Image src={doctorImg} alt='doctor' width={500} height={500} />
                    </div>
                </main>
            </div>
        </section>
